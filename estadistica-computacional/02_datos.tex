...
\begin{frame}
    ...
    \begin{alertblock}{Heurística: regla de Sturges}
        \begin{itemize}
            \item Se puede elegir cantidad $k = 1 + \log_{2} n$, donde $k$ es la cantidad de clases (intervalos) y $n$ la cantidad de datos.
            \item Alternativamente, puede usarse $k = 1 + 3.322\times\log_{10} n$.
        \end{itemize}
    \end{alertblock}
\end{frame}
