...
\begin{frame}
    ...
    \begin{block}{Definición}
        \begin{equation*}
            \pdf{x} = \frac{1}{\gammafunc{\alpha}\ \beta^{\alpha}} x^{\alpha - 1} e^{-  \frac{x}{\beta} } ,
...
\begin{frame}
    ...
    \begin{block}{Propiedades}
        \begin{itemize}
            \item $\expecteddist{X \sim \gammadist{\alpha}{\beta}}{X} = \mu_{X} = \alpha\ \beta$.
            \item $\variancedist{X \sim \gammadist{\alpha}{\beta}}{X} = \sigma^{2}_{X} = \alpha\ \beta^{2}$.
        \end{itemize}
    \end{block}
\end{frame}
